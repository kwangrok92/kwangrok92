<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:1a1a2e,100:16
213e&height=220&section=header&text=Kwangrok%20Kim&fontSize=42&fontAlign=50&fontCol
or=e94560&desc=iOS%20Developer%20%7C%204%2B%20Years&descSize=18&descAlign=50&descAl
ignY=75&fontAlignY=45" />
</p>
...
| Project | Period | Description | Scale |
|---------|--------|-------------|-------|
| **Geniet** | 2022.10 ~ 2025.12 | 건강관리 앱 핵심 기능 개발 (만보기, 캐시로또, 웹뷰 브릿지) | 3,560 commits · 106K+ lines |
| **CashHomeTraining** | 2024.02 ~ 2025.07 | SwiftUI + TCA 기반 홈트레이닝 모듈 (카메라, 음성 안내) | 395 commits · SPM 모듈 |
| **TownWalk** | 2025.08 ~ Present | 위치 기반 O2O 리워드 서비스 설계 및 구현 | 167 files · 40 PRs |
| **Home / Common** | 2025.10 ~ Present | 푸시 시스템 리팩토링, 코드 품질 표준화 | 415 files refactored |
...
### Multimedia
- AVFoundation 카메라 파이프라인 구축 (프레임 드랍 최적화)
- AVAudioSession 기반 음성 안내 시스템 (전화 인터럽트 처리)
- HealthKit 연동 걸음 수 추적 및 포인트 적립
